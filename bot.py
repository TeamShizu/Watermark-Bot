...
# Support Group: @ShizuSupport_Official 
# Bots Channel: @ShizuUpdates
...
async def HelpWatermark(bot, cmd):
	...
	await cmd.reply_text(
		...
		parse_mode="Markdown",
		reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/Mr_Rasiyaa"), InlineKeyboardButton("Support Group", url="https://t.me/ShizuSupport_Official")], [InlineKeyboardButton("Bots Channel", url="https://t.me/ShizuUpdates")], [InlineKeyboardButton("Source Code", url="https://github.com/TeamShizu/Watermark-Bot")]]),
...
async def VidWatermarkAdder(bot, cmd):
	...
	output_vid = main_file_name + "_[" + str(cmd.from_user.id) + "]_[" + str(time.time()) + "]_[@Mr_Rasiyaa]" + ".mp4"
	...
	if (int(file_size) > 2097152000) and (Config.ALLOW_UPLOAD_TO_STREAMTAPE is True) and (Config.STREAMTAPE_API_USERNAME != "NoNeed") and (Config.STREAMTAPE_API_PASS != "NoNeed"):
		...
		try:
			...
			print(f"Error: {e}")
			await editable.edit("Sorry, Something went wrong!\n\nCan't Upload to Streamtape. You can report at [Support Group](https://t.me/ShizuUpdates).")
...
async def button(bot, cmd: CallbackQuery):
	...
	if "refreshmeh" in cb_data:
			...
			try:
				...
				if user.status == "kicked":
					await cmd.message.edit(
						text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/ShizuSupport_Official).",
						parse_mode="markdown",
						disable_web_page_preview=True
					)
					return
				...
				await cmd.message.edit(
					text="Something went Wrong. Contact my [Support Group](https://t.me/ShizuSupport_Official).",
					parse_mode="markdown",
					disable_web_page_preview=True
				)
				return
		await cmd.message.edit(
			text=Config.USAGE_WATERMARK_ADDER,
			parse_mode="Markdown",
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/Mr_Rasiyaa"), InlineKeyboardButton("Support Group", url="https://t.me/ShizuSupport_Official")], [InlineKeyboardButton("Bots Channel", url="https://t.me/ShizuUpdates")]]),
			disable_web_page_preview=True
		)
