...
async def send_video_handler(bot, cmd, output_vid, video_thumbnail, duration, width, height, editable, logs_msg, file_size):
    ...
    sent_vid = await bot.send_video(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/Mr_Rasiyaa")],
                                           [InlineKeyboardButton("Bots Channel", url="https://t.me/ShizuSupport_Official")],
                                           [InlineKeyboardButton("Support Group", url="https://t.me/ShizuUpdates")]]),
        progress=progress_for_pyrogram,
        progress_args=(
            "Uploading, Wait Sir ... If not contact @ShizuUpdates",
            editable,
            logs_msg,
            c_time
        )
